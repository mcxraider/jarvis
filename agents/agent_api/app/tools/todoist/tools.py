...
- Priority format: 4 = urgent/P1 (default), 3 = high/P2, 2 = medium/P3, 1 = normal/P4.
...
- When scheduling a task that has a specific time, concurrently check for clashes with other timed tasks that day at the same time; if any overlap, tell the user and ask whether to reschedule.
