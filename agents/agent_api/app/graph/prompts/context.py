...
USER_PROMPTS: List[str] = [
    ...
    # "pull my events from google calendar and then update the team lunch task on todoist to p3."

    # "Find the plans i have with my teammate in the next 2 weeks, put them into google calendar events, then add to todoist a new team dinner next saturday."

    # "Find all my Todoist tasks and Google Calendar events involving my manager next week. Move anything after 6pm to the earliest free afternoon slot that same week, and mark the related Todoist tasks as P2.",

    # "Find all my plans with teammates across Todoist and Google Calendar for the next 3 weeks. If any Todoist-only plans have a clear date/time, create matching Google Calendar events. If any Calendar events don’t have Todoist prep tasks, add one 2 hours before. Avoid duplicates.",

    # "I want to host dinner next Saturday or Sunday evening with teammates. Check my calendar and Todoist for conflicts, choose the least busy evening, create the Google Calendar event, then add Todoist tasks to book a place, message everyone, and buy supplies.",
    ...
    # "Find the latest dinner/lunch/meetup plans. If any are overdue Todoist tasks, reschedule them to the next available weekend slot. If any conflict with existing Google Calendar events, move them to the nearest free evening and update both Todoist and Calendar consistently.",
    ...
    # "I think I have two duplicate lunch plans somewhere in Todoist or Google Calendar. Find the latest one, cancel the older duplicate, and make sure the remaining one is marked important.",
    ...
    # "Add team dinner next Saturday evening, but only if I don’t already have plans that day. If I do, combine them into one calendar event and update the Todoist task title accordingly.",
    ...
    # "help me find out what projects i have in todoist, ill ask u to add a task to one after that"
    # "set a dinner appointment with a colleague anytime during dinner next week at earliest available date. propose 3 dates and rank them by when im most free"
    # "when am i free next week?"
    # "delete my dinner event in my cal monday 8pm"
    # "meeting a colleague at night on friday, add it in"
    # "Go through my tasks, check everything that does not have a time. Tell me first and then I will ask you to make edits",
    # "put in my cal",
    # "can u add 24 tasks today each one titled ‘test-placeholder’",
    # "whats on my cal for this week?"
    # "how many tasks do i have today"
    # "delete all my test-placeholder tasks today"
    ...
    # "add 24 tasks titled ‘test-placeholder’ due tomorrow",
    ...
    # 15 is run twice — with and without the Berlin line.)
    ...
    # "Add a 1:1 with my manager this Thursday 10:30am to 11am.",
    ...
    # "Add a board 1:1 with director A next Tuesday 3pm.",
    # "Add a board 1:1 with director B next Thursday 3pm.",
    # "Add a board 1:1 with director C next Friday 3pm.",
    ...
    # "Add a 1:1 with my VP next Monday 3pm.",
    ...
    # "Add a weekly 1:1 with my manager every Tuesday at 2pm.",
    # "Add a weekly 1:1 with my tech lead every Thursday at 2pm.",
    ...
    # ── 15 · reasoning / conditional_branch_timezone  (run twice; drop the Berlin line for variant B) ──
    # "Add Berlin leg investor roadshow next Monday all day.",   # ← omit this line for the FALSE branch
    # "Add an analyst call next Tuesday 9am.",
    # "Add a partner sync next Tuesday 10am.",
    # "Add a team check-in next Tuesday 11am.",
    # "I land in London Tuesday morning. If the Berlin leg is still on my calendar, leave next week alone; otherwise shift Tuesday’s calls to after 2pm local.",  # conditional branch in one turn + ‘2pm local’ TZ conversion; A=no changes, B=shift after 2pm London
    ...
    #     1. Submit weekly report tomorrow at 9am
    #     2. Review experiment results tomorrow at 11am
    #     3. Buy groceries tomorrow evening
    #     4. Call family on Friday at 8pm
    #     5. Pay credit card bill on Friday
    #     6. Clean apartment on Saturday morning
    #     7. Go for a 5km run on Saturday at 5pm
    #     8. Meal prep for the week on Sunday at 3pm
    #     9. Read 2 chapters of textbook on Monday at 10am
    #     10. Finish project notes on Monday at 2pm
    #     11. Update project README on Tuesday at 4pm
    #     12. Book dentist appointment on Wednesday morning
    #     13. Prepare slides for team meeting next Thursday at 1pm
    #     14. Team dinner next Thursday at 7pm
    #     15. Return library books next Friday
    #     16. Plan trip itinerary next Saturday at 2pm
    #     17. Pack charger, adapter, toiletries, headphones and power bank as separate packing tasks next Sunday morning
    #     18. Review cloud compute costs on the 1st of next month
    ...
    #     9. Read 2 chapters of textbook
    #     10. Finish project notes
    #     11. Update project README
    #     12. Book dentist appointment
    #     13. Prepare slides for team meeting
    #     14. Team dinner
    #     15. Return library books
    #     16. Plan trip itinerary
    #     17. Pack charger
    #     18. Pack adapter
    #     19. Pack toiletries
    #     20. Pack headphones
    #     21. Pack power bank
    #     22. Review cloud compute costs
    ...
    #     Tasks:
    #     - tomorrow 9am submit weekly report
    #     - tomorrow 11am review experiment results
    #     - tomorrow evening buy groceries
    #     - Friday 8pm call family
    #     - Friday pay credit card bill
    #     - Saturday morning clean apartment
    #     - Saturday 5pm go for a 5km run
    #     - Sunday 3pm meal prep for the week
    #     - Monday 10am read 2 chapters of textbook
    #     - Monday 2pm finish project notes
    #     - Tuesday 4pm update project README
    #     - Wednesday morning book dentist appointment
    #     - next Thursday 1pm prepare slides for team meeting
    #     - next Thursday 7pm team dinner
    #     - next Friday return library books
    #     - next Saturday 2pm plan trip itinerary
    #     - next Sunday morning pack charger, adapter, toiletries, headphones, and power bank as separate Todoist tasks
    #     - 1st of next month review cloud compute costs
