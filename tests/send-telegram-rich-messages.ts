...
const chunks = [
  ...
  [
    ...
    '',
    '[^reasoning]Reason: Three meetings match your request, so I need to identify the correct one before updating your calendar.',
    '',
    '</details>',
  ],
  [
    ...
    '',
    '[^reasoning]Reason: Your previous personal tasks use different priority levels, so I don’t want to assume a default.',
    '',
    '</details>',
  ],
  // [
